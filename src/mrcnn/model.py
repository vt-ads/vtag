...
class MaskRCNN(object):
    ...
    def detect(self, images, batch=256, verbose=0):
        ...
        detections, _, _, mrcnn_mask, _, _, _ =\
            self.keras_model.predict([molded_images, image_metas, anchors], verbose=0, batch_size=batch)
        # Process detections
        results = []
    ...
    def detect_molded(self, molded_images, image_metas, verbose=0):
        ...
        # Run object detection
        detections, _, _, mrcnn_mask, _, _, _ =\
            self.keras_model.predict([molded_images, image_metas, anchors], verbose=0, batch_size=256)
        # Process detections
        results = []
